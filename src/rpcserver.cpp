...
string CRPCTable::help(string strCommand) const
{
    ...
    for (map<string, const CRPCCommand*>::const_iterator mi = mapCommands.begin(); mi != mapCommands.end(); ++mi)
    {
        ...
        if (fAllAnon)
        {
            if (strMethod != "sendmtotoken"
                && strMethod != "sendtokentotoken"
                && strMethod != "sendtokentom"
                && strMethod != "estimatetokenfee"
                && strMethod != "tokenoutputs"
                && strMethod != "tokeninfo"
                && strMethod != "reloadtokendata")
            continue;
        } else
...
{ //  name                      actor (function)         okSafeMode threadSafe reqWallet
  //  ------------------------  -----------------------  ---------- ---------- ---------
    ...
    { "sendmtotoken",         &sendmtotoken,         false,     false,     false },
    { "sendtokentotoken",       &sendtokentotoken,       false,     false,     false },
    { "sendtokentom",         &sendtokentom,         false,     false,     false },
    { "estimatetokenfee",       &estimatetokenfee,       false,     false,     false },
    { "tokenoutputs",           &tokenoutputs,           false,     false,     false },
    { "tokeninfo",              &tokeninfo,              false,     false,     false },
    { "reloadtokendata",        &reloadtokendata,        false,     false,     false },
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        std::string strWhatAmI = "To use md";
