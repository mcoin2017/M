...
macx {
    ...
    QMAKE_TARGET_BUNDLE_PREFIX = vtr
...
win32 {
    message(Building with for Windows)
    
    BOOST_LIB_SUFFIX=-mgw54-mt-s-1_62
    BOOST_INCLUDE_PATH=C:/deps/boost_1_62_0
    BOOST_LIB_PATH=C:/deps/boost_1_62_0/stage/lib
    BDB_INCLUDE_PATH=C:/deps/db-4.8.30.NC/build_unix
    BDB_LIB_PATH=C:\deps/db-4.8.30.NC/build_unix/.libs
	...
	PNG_LIB_PATH=C:/deps/libpng-1.6.20/.libs
...
contains(M_NEED_QT_PLUGINS, 1) {
    DEFINES += M_NEED_QT_PLUGINS
...
macx:ICON = src/qt/res/icons/m.icns
macx:TARGET = "M"
